...
namespace QuizApi.Services
{
    public class QuizService : IService<QuizDto>
    {
        ...
        internal IEnumerable<ActeurDto> TrouverTousLesUtilisateursDuQuiz(int id)
        {
            
            return ConvertDtoEntity.ConvertListActeurToListActeurDto(this.repository?.TrouverTousLesUtilisateursDuQuiz(id)?.ToList());
        }
